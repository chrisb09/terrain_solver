#!/bin/zsh
# Run remaining 15 cases (cases 56-70) for perfect_model (600k batch, c=4,5,6 x 5 reps)
# Executing 42 simulation steps per run (21 ML steps, 20 warm steady-state ML samples)

#SBATCH --job-name=CMI_SmartSim_42step_chain_part2
#SBATCH --account=thes2181
#SBATCH --time=01:30:00
#SBATCH --exclusive
#SBATCH --output=logs/scorep_chain_suite_part2_%j.txt
