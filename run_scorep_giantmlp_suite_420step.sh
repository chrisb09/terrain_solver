#!/bin/zsh
# Run 35 Score-P sequential-put cases for giant_mlp at 240x360 grid (bs=86400, chunks_x=4, chunks_z=6)
# Executing 420 simulation steps per run (210 ML steps, 200 warm steady-state ML samples)
# Total samples per config = 5 runs x 200 warm steps = 1000 samples

#SBATCH --job-name=CMI_SmartSim_420step_giantmlp_suite
#SBATCH --account=thes2181
#SBATCH --time=02:00:00
#SBATCH --exclusive
#SBATCH --output=logs/scorep_giantmlp_suite_420step_%j.txt
