#!/bin/zsh
# Run 35 Score-P sequential-put cases for watercnn at full 1/1 scale (8640x4320 grid, bs=600k)
# Executing 42 simulation steps per run (21 ML steps, 20 warm steady-state ML samples)

#SBATCH --job-name=CMI_SmartSim_42step_watercnn_suite
#SBATCH --account=thes2181
#SBATCH --time=01:30:00
#SBATCH --exclusive
#SBATCH --output=logs/scorep_watercnn_suite_%j.txt
