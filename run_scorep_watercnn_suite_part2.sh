#!/bin/zsh
# Run remaining 15 cases (cases 21-35) for watercnn at full 1/1 scale (c=4,5,6 x 5 reps)
# Executing 42 simulation steps per run (21 ML steps, 20 warm steady-state ML samples)

#SBATCH --job-name=CMI_SmartSim_42step_watercnn_part2
#SBATCH --account=thes2181
#SBATCH --time=01:30:00
#SBATCH --exclusive
#SBATCH --output=logs/scorep_watercnn_suite_part2_%j.txt
...
model_key="watercnn"
model_name="watercnn"
model_path="train_models/model_a/watercnn_cuda.pt"
manifest_path="train_models/model_a/artifact_manifest_watercnn_flat.json"
width=8640
height=4320
scale_label="scale1to1"

for chains in 4 5 6; do
  for repeat in 1 2 3 4 5; do
    ...
    run_log="${SCRIPT_DIR}/logs/scorep_watercnn_suite_${SUITE_ID}_${case_index}_${model_key}_${scale_label}_c${chains}_rep${repeat}.log"
